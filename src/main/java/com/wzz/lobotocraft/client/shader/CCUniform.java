...
public abstract class CCUniform extends Uniform implements ICCUniform {
    ...
    private static abstract class UniformEntry<T> extends CCUniform {
        ...
        public void setSafe(float f0, float f1, float f2, float f3) {
            assert type.getCarrier() == UniformType.Carrier.FLOAT;
            switch (type.getSize()) {
        ...
        public void glUniformI(int... values) {
            if (type.getCarrier() != UniformType.Carrier.INT && type.getCarrier() != UniformType.Carrier.U_INT) {
        ...
        public void glUniformF(boolean transpose, float... values) {
            if (type.getCarrier() != UniformType.Carrier.FLOAT && type.getCarrier() != UniformType.Carrier.MATRIX) {
        ...
        public void glUniformD(boolean transpose, double... values) {
            if (type.getCarrier() != UniformType.Carrier.DOUBLE && type.getCarrier() != UniformType.Carrier.D_MATRIX) {
