...
public class BlueGlintParticle extends TextureSheetParticle {
    ...
    public static class StParticleProvider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level,
            ...
            return new BlueGlintParticle(level, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
        }
    }

    public BlueGlintParticle(ClientLevel world, double x, double y, double z, double vx, double vy, double vz, SpriteSet spriteSet) {
        super(world, x, y, z);
        this.spriteSet = spriteSet;
