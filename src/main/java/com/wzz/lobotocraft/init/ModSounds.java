...
public class ModSounds {
	...
	public static final RegistryObject<SoundEvent> GREEN_NOON_START = register("green_noon_start");
	public static final RegistryObject<SoundEvent> GREEN_NOON_SHOOT = register("green_noon_shoot");
	public static final RegistryObject<SoundEvent> GREEN_NOON_CHAINSAW = register("green_noon_chainsaw");
	...
	public static final RegistryObject<SoundEvent> VIOLET_NOON_START = register("violet_noon_start");
	public static final RegistryObject<SoundEvent> VIOLET_NOON_END = register("violet_noon_end");
	...
	public static final RegistryObject<SoundEvent> BUTTERFLY_FUNERAL_WEAPON_MODE = register("butterfly_funeral_weapon_mode");
