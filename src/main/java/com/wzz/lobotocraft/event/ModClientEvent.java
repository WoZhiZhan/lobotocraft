...
public class ModClientEvent {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        ...
        event.registerEntityRenderer(ModEntities.butterfly_funeral.get(), (r) -> new AbnormalityRenderer<>(r, "butterfly", "butterfly", 1.4f, 1.2f));
        ...
        event.registerEntityRenderer(ModEntities.bigbadwolf.get(), (r) -> new EntityBigBadWolfRenderer(r, 1.0f, 1.0f));
        event.registerEntityRenderer(ModEntities.redhat_mercenary.get(), (r) -> new AbnormalityRenderer<>(r, "redhat", "redhat", 1.0f, 1.0f));
